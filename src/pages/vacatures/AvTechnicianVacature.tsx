...
import { ArrowRight, Lightbulb, Radio, Video } from "lucide-react";
import { Link } from "react-router-dom";
import avCrewMemberImg from "@/assets/av-crew-member.png";
import avControlImg from "@/assets/av-control.png";
import ctaLogo from "@/assets/cta-logo.svg";

const AvTechnicianVacature = () => {
              ...
              <div className="text-center mb-16 md:mb-20">
                <div className="max-w-4xl mx-auto space-y-2">
                  ...
                  <p className="text-base text-foreground/70 leading-relaxed">
                    Als AV-technician ben je verantwoordelijk voor het technische hart van elk evenement. Je installeert en configureert licht-, geluid- en/of videosystemen en zorgt ervoor dat alles perfect werkt tijdens de show. Je werkt met professionele apparatuur en draagt bij aan onvergetelijke ervaringen voor duizenden bezoekers.
                  </p>
                </div>
              </div>
                ...
                <div className="flex justify-center lg:justify-start">
                  <div className="relative w-full max-w-sm h-full">
                    <div className="relative rounded-xl overflow-visible h-full">
                      ...
                      {/* AV crew member image - fills purple box */}
                      <img
                        src={avControlImg}
                        alt="AV-technician aan het werk"
                ...
                <div>
                  ...
                  <div className="mb-12">
                    ...
                    <ul className="space-y-2 text-foreground/70">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-accent mt-1">•</span>
                        <span>Probleemoplossend vermogen en teamplayer.</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-accent mt-1">•</span>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                  ...
                  >
                    ...
                    <p className="text-foreground/70 text-sm leading-relaxed">
                      Je monteert en installeert lichtinstallaties, verzorgt de bekabeling en programmeert lichtscenes. Tijdens shows bedien je de lichttafel en zorg je voor de perfecte sfeer met dynamische verlichting.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-foreground/70 text-sm leading-relaxed">
                      Je plaatst en positioneert speakers, sluit microfoons aan en verzorgt de geluidsmix. Je werkt aan soundchecks en zorgt voor optimaal geluid tijdens het evenement.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-foreground/70 text-sm leading-relaxed">
                      Je monteert LED-walls en projectieschermen, sluit mediaservers aan en verzorgt de videodistributie. Tijdens shows monitor je de systemen en los je technische problemen snel op.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-foreground/70 text-sm leading-relaxed">
                      Je bedient videosystemen tijdens live events en presentaties. Je volgt het draaiboek en werkt nauw samen met de regie om de juiste beelden op het juiste moment te tonen.
                    </p>
                  </div>
...
export default AvTechnicianVacature;
